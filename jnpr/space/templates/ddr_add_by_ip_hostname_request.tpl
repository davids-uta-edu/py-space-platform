...
{%- endif %}
    <discovery-type>IP_HOSTNAME</discovery-type>
    <device-targets>
{%- for device_target in device_targets %}
        <device-target>
            <ip-address>{{device_target.ip_address|d("")}}</ip-address>
            <host-name>{{device_target.host_name|d("")}}</host-name>
            <base-ip>{{device_target.base_ip|d("")}}</base-ip>
	    <subnet-mask>{{device_target.subnet_mask|d("")}}</subnet-mask>
	    <upper-ip>{{device_target.upper_ip|d("")}}</upper-ip>
	    <lower-ip>{{device_target.lower_ip|d("")}}</lower-ip>
